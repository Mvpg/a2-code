...
var cloak = {
	...
	get: function () {
		...
		// Add the cloak to the inventory list paragraph
		document.getElementById('InventoryList').innerHTML = cloak.menuCreate();

		//document.getElementById("RoomPic").src="img/nocloak.jpg";
	},
	...
	putOn: function () {
		...
		if (bar.location == 'dark'){
			var detail =
				"<p>After you put the cloak on, you can see the room clearly now!</p>" +
				"<p>The bar, much rougher than you'd have guessed after the " +
				"opulence of the " +
				"<a href='#' onclick='enterFoyer()'>foyer</a>, " +
				"is completely empty. There seems to be some sort of " +
				bar.menuCreate() +
				" scrawled in the dust on the floor.</p>";
				roomPara = document.getElementById('RoomDesc');
				roomPara.innerHTML = roomPara.innerHTML = detail;
